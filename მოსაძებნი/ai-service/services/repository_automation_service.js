...
class RepositoryAutomationService {
  constructor() {
    ...
    this.automationConfig = {
      ...
      requiredWebhooks: [
        {
          ...
          config: {
            url: `${this.replitUrl}/api/ai/github/webhook/github`,
            content_type: 'json',
            insecure_ssl: '0'
          }
        }
      ...
      repositoryTopics: [
        'ai-assistant', 'typescript', 'react', 'nodejs', 'replit',
        'georgian-language', 'automation', 'web-development', 'ai'
      ],
      branchProtectionRules: {
        main: {
          required_status_checks: {
            strict: true,
            contexts: ['CI/CD Pipeline', 'Quality Checks']
          },
  ...
  async validateConfiguration() {
    ...
    if (!this.replitUrl) {
      issues.push('Replit URL not configured');
    }
