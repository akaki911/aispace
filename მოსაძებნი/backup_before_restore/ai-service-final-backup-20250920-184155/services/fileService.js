...
class FileService {
  ...
  async writeFile(filePath, content) {
    try {
      ...
      console.info(`Data saved to DB: ${filePath}`);
      return {
        success: true,
...
// FileService Aliases Module
// ფაილური სერვისის ალიასების მოდული
// 
// This module provides aliases for file_access_service.js functions
...
module.exports = {
  ...
  readFileContent: fileAccessService.readFileContent,
  replaceFileContent: fileAccessService.replaceFileContent,
  searchInFiles: fileAccessService.searchInFiles,
  
  // Additional file utilities
  getFileContent: fileAccessService.readFileContent, // Alias for compatibility
  writeFileContent: fileAccessService.replaceFileContent, // Alias for compatibility
  
  // Directory operations
  listFiles: fileAccessService.listFiles || (() => []),
  fileExists: fileAccessService.fileExists || (() => false),
  
  // Enhanced search capabilities
  findInProject: fileAccessService.searchInFiles,
  searchByPattern: fileAccessService.searchInFiles
};
