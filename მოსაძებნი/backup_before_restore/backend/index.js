...
console.log('🔧 SESSION_SECRET:', process.env.SESSION_SECRET ? 'SET (' + process.env.SESSION_SECRET.length + ' chars)' : 'NOT_SET');
console.log('🔧 ADMIN_SETUP_TOKEN:', process.env.ADMIN_SETUP_TOKEN ? 'SET (' + process.env.ADMIN_SETUP_TOKEN.length + ' chars)' : 'NOT_SET');
