...
export class GeorgianAutoCorrection {
  ...
  correctText(text: string, options: Partial<GeorgianEnhancementOptions> = {}): GeorgianTextAnalysis {
    ...
    return this.analyzeText(correctedText, suggestedCorrections);
  }

  private analyzeText(text: string, corrections: Array<{original: string, corrected: string, confidence: number, rule: string}>): GeorgianTextAnalysis {
