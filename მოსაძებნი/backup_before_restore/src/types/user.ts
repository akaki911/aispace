export interface User {
  ...
  createdAt: Date;
  updatedAt: Date;
  // დამატებითი ველები პროვაიდერებისთვის
  phoneNumber?: string; // მობილურის ნომერი (სავალდებულო პროვაიდერებისთვის)
  personalId?: string; // პირადი ნომერი (11 ციფრი, სავალდებულო)
