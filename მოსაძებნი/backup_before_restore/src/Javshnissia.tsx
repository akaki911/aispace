    ...
    <div className="flex gap-1">
      ...
      {booking.status === 'pending' && (
        <motion.button
          ...
          className="relative btn-tooltip p-2 text-green-600 hover:bg-green-50 dark:hover:bg-green-900/20 rounded-lg transition-all duration-200 bg-white/90 dark:bg-gray-800/90 shadow-sm"
          title="დადასტურება"
        >
