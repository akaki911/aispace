      ...
      <div className="max-w-7xl mx-auto px-4 py-8">
          ...
          <div className="space-y-6">
            ...
            <div className="bg-white p-6 rounded-xl shadow-sm">
              <div className="text-3xl font-bold text-blue-600 mb-2">
                {currentPricing.currentPrice || cottage.pricePerNight}₾ <span className="text-lg text-gray-600 font-normal">/ ღამე</span>
              </div>
              {currentPricing.season && currentPricing.season !== 'other' && (
                <div className="mb-4 p-3 bg-blue-50 rounded-lg border border-blue-200">
                  <p className="text-sm text-blue-800 font-medium">
                    მიმდინარე სეზონი: <span className="font-bold">{currentPricing.season}</span>
                  </p>
                  <p className="text-xs text-blue-600 mt-1">
                    ფასი 3 ადამიანზე ოჯახისთვის • იცვლება სტუმრების რაოდენობისა და ვადის მიხედვით
                  </p>
                </div>
              )}
              <button
        ...
        {showBookingModal && cottage && id && (
          <BookingModal
            ...
            onSuccess={() => {
              // Handle successful booking and refresh data
              console.log('Booking successful');
              // Optionally refresh booked dates here
            }}
          />
        )}
      </div>
