...
const AdminProviders: React.FC = () => {
  ...
  const fetchProviders = async () => {
    try {
      ...
      const providersData = querySnapshot.docs
        ...
        .filter(user => user.role === 'provider') as Provider[];
  ...
  const deleteProvider = async (providerId: string) => {
    if (window.confirm('დარწმუნებული ხართ რომ გსურთ პროვაიდერის წაშლა?')) {
      try {
        ...
        <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-purple-50 dark:from-gray-900 dark:via-gray-800 dark:to-purple-900 transition-colors">
          <div className="flex items-center justify-center h-64">
            <div className="flex flex-col items-center space-y-4">
              ...
              <p className="text-gray-600 dark:text-gray-400 font-medium">პროვაიდერების ჩატვირთვა...</p>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-purple-50 dark:from-gray-900 dark:via-gray-800 dark:to-purple-900 transition-colors">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          ...
          <div className="mb-8">
            <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between">
              <div className="mb-6 lg:mb-0">
                ...
                <p className="text-lg text-gray-600 dark:text-gray-400">მართეთ პროვაიდერები ერთ ადგილას</p>
              </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
            ...
            >
              <div className="flex items-center justify-between">
                <div>
                  <p className="text-sm font-medium text-rose-700 dark:text-rose-300">აქტიური</p>
            ...
            >
              <div className="flex items-center justify-between">
                <div>
                  <p className="text-sm font-medium text-emerald-700 dark:text-emerald-300">არააქტიური</p>
                  <p className="text-3xl font-bold text-emerald-900 dark:text-emerald-100">
                    {providers.filter(p => !p.isActive).length}
                  </p>
                </div>
                <div className="bg-emerald-100/80 dark:bg-emerald-900/40 p-3 rounded-xl shadow-lg">
                  <XCircle className="w-6 h-6 text-emerald-600 dark:text-emerald-400" />
                </div>
              </div>
            </motion.div>
            ...
            >
              <div className="flex items-center justify-between">
                <div>
                  <p className="text-sm font-medium text-indigo-700 dark:text-indigo-300">ახალი (მხოლოდ კვირა)</p>
            ...
            >
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-3xl font-bold text-purple-900 dark:text-purple-100">{providers.length}</p>
                </div>
          ...
          <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-lg border border-gray-100 dark:border-gray-700 p-6 mb-8">
            <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4">
              ...
              <div className="relative flex-1 max-w-md">
                ...
                <input
                  type="text"
                  placeholder="ძებნა სახელით, ელ. ფოსტით ან ბიზნესით..."
                  value={searchTerm}
          ...
          {filteredProviders.length === 0 ? (
            ...
            >
              <div className="mb-6">
                <Building className="w-24 h-24 text-gray-300 dark:text-gray-600 mx-auto mb-4" />
                <h3 className="text-2xl font-bold text-gray-900 dark:text-white mb-2">პროვაიდერები ვერ მოიძებნა</h3>
                <p className="text-gray-600 dark:text-gray-400">სცადეთ სხვა საძიებო კრიტერიუმები</p>
              </div>
            </motion.div>
          ) : (
                ...
                >
                  <div className="p-6">
                    <div className="flex items-center justify-between mb-4">
                      <div className="flex items-center">
                        ...
                        <div className="ml-3">
                          ...
                          <p className="text-sm text-gray-500 dark:text-gray-400">{provider.businessName || 'ბიზნესი'}</p>
                        </div>
                      </div>
                      {provider.isActive ? (
                    ...
                    <div className="space-y-2 mb-4">
                      ...
                      <p className="text-sm text-gray-600 dark:text-gray-400">🆔 {provider.personalId}</p>
                      {provider.address && (
                        <p className="text-sm text-gray-600 dark:text-gray-400">📍 {provider.address}</p>
                      )}
                    </div>
                      ...
                      <button
                        ...
                        className={`flex-1 px-3 py-2 rounded-lg text-sm font-medium transition-colors ${
                          provider.isActive
                            ...
                            : 'bg-green-100 dark:bg-green-900 dark:bg-opacity-20 text-green-700 dark:text-green-300 hover:bg-green-200 dark:hover:bg-green-900 dark:hover:bg-opacity-30'
                        }`}
                      >
                        {provider.isActive ? 'გაუქმება' : 'გააქტიურება'}
                      </button>
                      <button
