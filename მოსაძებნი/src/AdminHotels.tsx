                      ...
                      <div className="flex items-start justify-between">
                        ...
                        <div className="flex items-start space-x-2">
                          {hotel.roomTypes && hotel.roomTypes.length > 0 ? (
                            <span className="bg-green-100 dark:bg-green-900 dark:bg-opacity-30 text-green-800 dark:text-green-200 text-xs font-medium px-2.5 py-1 rounded-full flex items-center gap-1.5 min-w-[85px]">
