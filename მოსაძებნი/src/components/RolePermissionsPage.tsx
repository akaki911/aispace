...
import { Permission, Role } from '../contexts/PermissionsContext';
...
const PERMISSION_LABELS: Record<Permission, string> = {
  ...
  'view_messaging': 'საუბრის ნახვა',
  'send_messages': 'შეტყობინებების გაგზავნა',
  'create_support_conversations': 'საპორტის საუბრის შექმნა',
  'ai_developer_access': 'AI დეველოპერის ხელმისაწვდომობა',
  'view_gurulo_overview': 'გურულოს ჯამური ხედვა',
  'edit_gurulo_prompts': 'პრომპტის რედაქტირება',
  'manage_gurulo_users': 'AI მომხმარებლების მართვა',
  'manage_gurulo_ui': 'AI UI & ანიმაციები',
  'view_gurulo_analytics': 'AI ანალიტიკის ნახვა',
  'manage_gurulo_integrations': 'AI ინტეგრაციების მართვა',
  'view_ai_diagnostics': 'AI დიაგნოსტიკის ნახვა'
};
