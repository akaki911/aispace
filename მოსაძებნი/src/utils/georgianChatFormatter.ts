...
import type { GeorgianParseResult, GeorgianGrammarSuggestion } from './georgianGrammarParser';
...
export interface GuruloFormattedMessage {
  ...
  grammarInsights?: GeorgianParseResult | null;
  grammarSuggestions?: GeorgianGrammarSuggestion[];
}
...
export const formatGeorgianMessage = (content: unknown, options: {
...
export const enhanceWithMemory = (
  ...
  const grammarInsights = languageAnalysis.grammar;
  ...
  return {
    ...
    terminologyEnhancements,
    grammarInsights,
    grammarSuggestions: grammarInsights?.suggestions
  };
};
