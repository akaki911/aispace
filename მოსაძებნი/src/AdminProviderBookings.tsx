...
const AdminProviderBookings: React.FC = () => {
  ...
  const getStatusColor = (status: string) => {
    switch (status) {
      ...
      case 'confirmed': return 'bg-green-100 dark:bg-green-900 dark:bg-opacity-20 text-green-800 dark:text-green-300';
                    ...
                    {booking.status === 'pending' && (
                      <div className="flex space-x-2">
                        <button
                          ...
                          className="flex-1 px-3 py-2 bg-green-100 dark:bg-green-900 dark:bg-opacity-20 text-green-700 dark:text-green-300 rounded-lg hover:bg-green-200 dark:hover:bg-green-900 dark:hover:bg-opacity-30 transition-colors text-sm font-medium"
                        >
                          დადასტურება
                        </button>
                        <button
