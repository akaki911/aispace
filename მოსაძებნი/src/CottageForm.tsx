                    ...
                    >
                      <div className="p-8 space-y-8">
                                  ...
                                  <div className="flex items-center justify-between mb-4">
                                    ...
                                    <div className="flex items-center space-x-2">
                                      ...
                                      <motion.button
                                        ...
                                        className="p-2 bg-green-100 dark:bg-green-900 dark:bg-opacity-30 text-green-700 dark:text-green-300 rounded-lg hover:bg-green-200 dark:hover:bg-green-900 dark:hover:bg-opacity-50 transition-colors"
                        ...
                        {activeMonths.length === 0 && (
                          <div className="bg-green-50 dark:bg-green-900 dark:bg-opacity-20 border-2 border-green-200 dark:border-green-800 rounded-xl p-6">
                            <div className="flex items-start space-x-4">
